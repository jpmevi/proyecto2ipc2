<%-- 
    Document   : VerCitaMedica
    Created on : Oct 4, 2020, 6:44:54 PM
    Author     : potz
--%>
                ...
                <table class="containero" style="z-index: 99;">
                    ...
                    <%            String filtro;
                        ...
                        try {
                            ...
                            rs = cm.buscarCitaMedica(atributo, filtro, String.valueOf(session.getAttribute("Paciente")));
                            if (!(rs.next())) {
                    ...
                    <tr>
                        ...
                        <td>
                            <h2><a href="VerCitaMedica.jsp?&codigo=<%=rs.getString("codigo")%>">Eliminar</a></h2>
                        </td>
                    </tr>
