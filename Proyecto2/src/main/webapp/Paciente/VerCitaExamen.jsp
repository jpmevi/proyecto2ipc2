<%-- 
    Document   : VerCitaExamen
    Created on : Oct 6, 2020, 12:33:59 AM
    Author     : potz
--%>
                ...
                <table class="containero" style="z-index: 99;">
                    ...
                    <%            String filtro;
                        ...
                        try {
                            ...
                            rs = cm.buscarCitaExamen(atributo, filtro, String.valueOf(session.getAttribute("Paciente")));
                            if (!(rs.next())) {
                    ...
                    <tr>
                        ...
                        <td><h2><%= String.valueOf(rs.getObject("laboratorista"))%></h2></td>
                        <td><h2><%= String.valueOf(rs.getObject("examen"))%></h2></td>
                        <td>
                            <h2><a href="VerCitaExamen.jsp?&codigo=<%=rs.getString("codigo")%>">Eliminar</a></h2>
                        </td>
                    </tr>
