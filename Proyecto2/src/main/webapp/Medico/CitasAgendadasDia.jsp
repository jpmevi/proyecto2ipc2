<%-- 
    Document   : CitasAgendadasDia
    Created on : Oct 7, 2020, 7:14:35 AM
    Author     : potz
--%>
...
<html>
    <head>
        ...
        <title>Citas Agendadadas este dia</title>
    </head>
                ...
                <table class="containero" style="z-index: 99;">
                    <%  Cita_Medica cm = new Cita_Medica();
                        ...
                        try {
                            ...
                            rs = cm.buscarDia(String.valueOf(session.getAttribute("Medico")));
                            if (!(rs.next())) {
