<%-- 
    Document   : PacienteMasInformes
    Created on : Oct 7, 2020, 7:22:52 AM
    Author     : potz
--%>
...
<html>
    <head>
        ...
        <title>Pacientes con mas informes</title>
    </head>
               ...
               <h4>Fecha final:</h4>
                ...
                <table class="containero" style="z-index: 99;">
                    ...
                    <tr>
                        ...
                        <td><h2><%= String.valueOf(rs.getObject("informes"))%></h2></td>
                    </tr>
