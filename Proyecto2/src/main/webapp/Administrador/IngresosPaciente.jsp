<%-- 
    ...
    Created on : Oct 8, 2020, 4:12:33 AM
    Author     : potz
--%>
...
<html>
    <head>
        ...
        <title>Ingresos generados por paciente</title>
    </head>
                ...
                <table class="containero" style="z-index: 99;">
                   ...
                   %><h4>No hay ningun Paciente con ingresos</h4><%
                    ...
                    %> <tr>
                        ...
                        <th><h1>Ingresos</h1></th>
                    </tr>
                    <%                        while (rs.next()) {
                    %>
                    <tr>
                        <td><h2><%= String.valueOf(rs.getObject("paciente"))%></h2></td>
                        <td><h2><%= String.valueOf(rs.getObject("ingresos"))%></h2></td>
                    </tr>
